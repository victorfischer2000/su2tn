...
def fuse_neighboring_legs_degeneracy_tensors(su2tensor, df, irrep1_idx, irrep2_idx):
    ...
    """
    print('indices', irrep1_idx, irrep2_idx)
...
def fuse_neighboring_legs_updatesu2tensor_inplace(su2tensor,
    ...
    # if not (len(newFusionTree) == 1 and 0 in newFusionTree[0]):
    #     su2tensor.numberOfInternalEdges = su2tensor.numberOfInternalEdges - 1

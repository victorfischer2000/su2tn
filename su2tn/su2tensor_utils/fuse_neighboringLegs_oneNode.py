...
def fuse_neighboring_legs_oneNode(su2tensor, irrep1Name, irrep2Name):
    """
    ...
    if len(su2tensor.fusionTree) != 1:
        ...
        newFusionTree, newFusionTreeDirections = fuse_neighboring_legs_updatefusiontree_oneNode(su2tensor=su2tensor,
                                                                                                fusionNode=fusionNode,
                                                                                                irrep1Name=irrep1Name,
                                                                                                irrep12Name=irrep12Name)
...
def fuse_neighboring_legs_chargesector_groups(su2tensor, irrep1Name, irrep2Name, irrep12Name):
    ...
    for idx, (newChargeSector, df) in enumerate(cs_groups):
        ...
        newChargeSectors.append([irrep12, irrep12])
...
def fuse_neighboring_legs_update_openLegs(su2tensor, irrep1Name, irrep2Name, edgeIrreps12):
    ...
    newOpenLeg['originalIrreps'] = [(irrep1Name, edgeIrreps12), (irrep1Name, openLeg1History), (irrep2Name, openLeg2History)]
